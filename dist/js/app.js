(() => {
    ...
    function initSliders() {
        if (document.querySelector(".fullscreen__slider")) new swiper_core_Swiper(".fullscreen__slider", {
    ...
    window.addEventListener("resize", (() => {
        ...
        if (widthChanged || heightChanged) location.reload();
        prevWidth = window.innerWidth;
        prevHeight = window.innerHeight;
    }));
    window.addEventListener("scroll", (function() {
        const header = document.querySelector(".header");
        if (window.scrollY > 100) header.classList.add("small"); else header.classList.remove("small");
    }));
    window.addEventListener("scroll", (function() {
        const header = document.querySelector(".header");
        if (window.scrollY > 100) header.classList.add("header--scrolled"); else header.classList.remove("header--scrolled");
    }));
